...
resource "azurerm_key_vault_secret" "create_updates_queue_send_conn_str_prm" {
  ...
  value        = module.create-updates-queue-premium.primary_send_connection_string
...
resource "azurerm_key_vault_secret" "create_updates_queue_listen_conn_str_prm" {
  ...
  value        = module.create-updates-queue-premium.primary_listen_connection_string
  key_vault_id = module.et-key-vault.key_vault_id
}

resource "azurerm_key_vault_secret" "create_updates_queue_max_delivery_count_prm" {
  name         = "create-updates-queue-max-delivery-count-premium"
...
resource "azurerm_key_vault_secret" "update_case_queue_send_conn_str_prm" {
  ...
  value        = module.update-case-queue-premium.primary_send_connection_string
  key_vault_id = module.et-key-vault.key_vault_id
}
...
resource "azurerm_key_vault_secret" "update_case_queue_listen_conn_str_prm" {
  ...
  value        = module.update-case-queue-premium.primary_listen_connection_string
  key_vault_id = module.et-key-vault.key_vault_id
}

resource "azurerm_key_vault_secret" "update_case_queue_max_delivery_count_prm" {
  name         = "update-case-queue-max-delivery-count-premium"
  value        = var.queue_max_delivery_count
  key_vault_id = module.et-key-vault.key_vault_id
}
...
output "create_updates_queue_primary_listen_connection_string_prm" {
  sensitive = true
  value     = module.create-updates-queue-premium.primary_listen_connection_string
}

output "create_updates_queue_primary_send_connection_string_prm" {
  sensitive = true
  value     = module.create-updates-queue-premium.primary_send_connection_string
}

output "update_case_queue_primary_listen_connection_string_prm" {
  sensitive = true
  value     = module.update-case-queue-premium.primary_listen_connection_string
}

output "update_case_queue_primary_send_connection_string_prm" {
  sensitive = true
  value     = module.update-case-queue-premium.primary_send_connection_string
}

output "queue_max_delivery_count_prm" {
  value = var.queue_max_delivery_count
}