...
resource "azurerm_servicebus_topic_authorization_rule" "ccd_case_events_topic_send" {
  ...
  topic_id = data.azurerm_servicebus_topic.ccd_case_events_topic.id
...
resource "azurerm_key_vault_secret" "ccd_case_events_send_primary_connection_string" {
  ...
  value        = azurerm_servicebus_topic_authorization_rule.ccd_case_events_topic_send.primary_connection_string
